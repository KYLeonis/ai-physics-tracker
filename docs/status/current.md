...
> Publication worktree note（2026-09-21）：本文件保留 main 通用线状态。本 worktree 的 EJP 平台独立规划、科学契约与下一步见 [publication/STATUS.md](../../publication/STATUS.md) 和 [PHASE_PLAN.md](../../publication/PHASE_PLAN.md)；不以 main Phase 6 完成为前置。P0已完成；**P1.1 S1–S4 已实现并通过两轮独立 review(899 tests,分支 `feat/p1.1-pendulum-setup` 未合并)**;P1.1 S5 GUI/S6 集成与其余 P1.2–P1.4 未开始。Windows验证已获用户明确批准延期至P6前。
