...
- 最近完成：**Phase 2.2 — Playback & Viewport（✅ 2026-08-29）**
- 当前阶段：**Phase 2 — Video Analysis MVP（🔄 Subphase 2.2 ✅，等待 2.3 指令）**
...
**验收标准**
- [ ] 打开一段常见格式视频（MP4/H.264）流畅播放并可逐帧步进
- [ ] 可在任意帧手工标记目标位置，形成轨迹
- [ ] 关闭重开后项目状态完整恢复
...
**验收标准**
- [ ] 标定后坐标转换误差满足设计精度（合成数据测试）
- [ ] 用匀速/匀加速合成数据验证 v/a 计算正确
- [ ] 图表与视频帧同步联动
