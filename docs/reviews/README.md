...
| Publication P1.2 (S1–S6) | [publication-p1.2-review.md](publication-p1.2-review.md) | 三轮专项 review 闭环(981 passed, DLC smoke PASS);HR 自动化执行 A–D 全 PASS、否决项干净,3 findings 非阻塞(F1 首次入口跳帧/F2 Space 抢占/F3 折叠按钮待用户真机复核);待用户裁定后合并 | 2026-09-24 |
